...
export const metadata: Metadata = {
  ...
  description: 'Valorisez vos toitures et parkings : mise en conformité Loi LOM et Décret Tertiaire. Calculez votre ROI photovoltaïque en 2 minutes. Solution B2B pour entreprises et industrie (C&I).',
  keywords: ['photovoltaïque B2B', 'solaire entreprise', 'Loi LOM', 'Décret Tertiaire', 'PPA', 'ombrière parking', 'toiture solaire', 'ROI photovoltaïque', 'autoconsommation', 'énergie renouvelable', 'France'],
