...
/* ═══════════════════════════════════════════════
   Component: Revolut Pay Button (simulated)
   ═══════════════════════════════════════════════ */
        ...
        <div className="mx-auto flex max-w-5xl items-center justify-between gap-4 px-4 py-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-3">
            <Link
              ...
              className="flex h-9 w-9 items-center justify-center rounded-xl bg-white/[0.06] text-neutral-400 transition-colors hover:text-white"
            >
      ...
      <main className="relative z-10 mx-auto max-w-5xl px-4 py-10 sm:px-6 lg:px-8">
        ...
        >
          <div className="mb-3 flex items-center gap-2">
            <CreditCard className="h-5 w-5 text-[#FFC300]" />
            <h2 className="text-lg font-bold text-white">Recharger mon compte</h2>
          </div>
                ...
                >
                  {pack.popular && (
                    <div className="absolute -top-3 left-1/2 z-10 -translate-x-1/2">
                      <Badge className="gap-1 border-[#FFC300]/30 bg-[#FFC300] px-3 py-0.5 text-[10px] font-bold uppercase tracking-wider text-[#001D3D]">
                  ...
                  <GlassCard
                    className={`p-6 transition-all ${
                      isSelected
                        ? "border-[#FFC300]/30 shadow-[0_0_30px_rgba(255,195,0,0.1)]"
                        : ""
                    }`}
                  >
                    <div className="mb-4 flex items-center justify-between">
                      <span className="text-4xl font-extrabold tabular-nums text-[#FFC300]">
                        {pack.credits}
                      </span>
                      {pack.saving && (
        ...
        >
          ...
          {transactions.length === 0 ? (
            <GlassCard className="px-6 py-10 text-center">
              <TrendingUp className="mx-auto h-6 w-6 text-neutral-600" />
              <p className="mt-2 text-sm text-neutral-500">Aucune transaction pour le moment.</p>
            </GlassCard>
          ) : (
